---
name: doc:c4
description: Generate comprehensive C4 architecture documentation for an existing repository
...
All documentation is written to a new `docs/c4/` directory in the repository root.
...
- Use Task tool with subagent_type="c4-arch::c4-code"
- Prompt: |
  ...
  Save the output as: docs/c4/c4-code-[directory-name].md
...
- Expected output: c4-code-<directory-name>.md file in docs/c4/
...
- Use Task tool with subagent_type="c4-arch::c4-component"
- Prompt: |
  ...
  Save the output as: docs/c4/c4-component-[component-name].md
...
- Prompt: |
  ...
  Save the output as: docs/c4/c4-component.md
...
- Use Task tool with subagent_type="c4-arch::c4-container"
- Prompt: |
  ...
  5. **API Specifications**:
     ...
     - Save as: docs/c4/apis/[container-name]-api.yaml
     - Include:
  ...
  Save the output as: docs/c4/c4-container.md
...
- Use Task tool with subagent_type="c4-arch::c4-context"
- Prompt: |
  Create comprehensive C4 Context-level documentation for the system.

  Container documentation: docs/c4/c4-container.md
  Component documentation: docs/c4/c4-component.md
  ...
  Save the output as: docs/c4/c4-context.md
...
- `output_directory`: Where to write C4 documentation (default: docs/c4/)
...
- ✅ Documentation is organized in docs/c4/ directory
...
All documentation written to: docs/c4/
