---
name: c4-code
description: "Document code at C4 Code-level with function signatures and dependencies. <example>Context: Code documentation. user: \"Document the src/api directory at code level\" assistant: \"I'll use c4-code to analyze and document code elements\" <commentary>Code-level is first C4 step.</commentary></example> <example>Context: Bottom-up C4. user: \"Create C4 docs starting from code level\" assistant: \"I'll use c4-code to document functions and classes\" <commentary>Bottom-up starts with code level.</commentary></example>"
model: haiku
