---
name: c4-context
description: "Create high-level C4 Context documentation with system overview and user journeys. <example>Context: System documentation. user: \"Create system context documentation\" assistant: \"I'll use c4-context to document personas and journeys\" <commentary>Context is highest level C4.</commentary></example> <example>Context: Stakeholder docs. user: \"Document system for non-technical stakeholders\" assistant: \"I'll use c4-context to create stakeholder-friendly overview\" <commentary>Context docs are stakeholder-friendly.</commentary></example>"
model: sonnet
