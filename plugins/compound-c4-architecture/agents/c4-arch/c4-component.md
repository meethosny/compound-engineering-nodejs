---
name: c4-component
description: "Synthesize C4 Code docs into Component-level architecture. <example>Context: Component boundaries. user: \"Synthesize code docs into components\" assistant: \"I'll use c4-component to group code into logical components\" <commentary>Component level synthesizes code docs.</commentary></example> <example>Context: Define interfaces. user: \"Create component boundaries from code docs\" assistant: \"I'll use c4-component to identify component interfaces\" <commentary>Component boundaries need definition.</commentary></example>"
model: sonnet
