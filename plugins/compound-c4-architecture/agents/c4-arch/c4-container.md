---
name: c4-container
description: "Synthesize Components into Container-level deployment architecture. <example>Context: Deployment mapping. user: \"Map components to deployment containers\" assistant: \"I'll use c4-container to create container architecture\" <commentary>Container level maps to deployment.</commentary></example> <example>Context: Container APIs. user: \"Document container APIs and deployment units\" assistant: \"I'll use c4-container to create OpenAPI specs and docs\" <commentary>Container docs include API specs.</commentary></example>"
model: sonnet
