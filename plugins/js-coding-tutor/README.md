...
```
/plugin install js-coding-tutor
```
...
- `/js-teach-me` - Learn something new
- `/js-quiz-me` - Test your retention with spaced repetition
- `/js-sync-tutorials` - Sync your tutorials to GitHub for backup
