...
> Diff-scoped browser QA of `<branch>` vs `main`. Generated by `/js-ce:dogfood-beta` on <YYYY-MM-DD>.
...
<Reusable lessons worth carrying forward — patterns, gotchas, product/UX insights. Feed substantial ones to `js-ce-compound`.>
