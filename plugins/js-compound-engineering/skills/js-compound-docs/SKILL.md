...
- Foundational requirement (Node.js, Express, Fastify, Hono, async patterns, etc.)
...
Action:
1. Prompt: "Which skill? (frontend-design, modern-nodejs-style, etc.)"
...
Example: For React state management solution:
- Add to `frontend-design/references/resources.md` under "Project-Specific Resources"
- Add to `frontend-design/references/examples.md` with link to solution doc
...
2. **Gather context:**
   ...
   - Solution: Added `include: { emails: true }` in Prisma query
