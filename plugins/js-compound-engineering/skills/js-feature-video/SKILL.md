...
<requirements>
- Local development server running (e.g., `npm run dev`, `node server.js`)
...
/js-feature-video 847

# Record with custom base URL
/js-feature-video 847 http://localhost:5000

# Record for staging environment
/js-feature-video current https://staging.example.com
```
