...
```
Skill("js-compound-engineering:document-review", "mode:headless docs/plans/my-plan.md")
```
...
**If no document is specified (headless mode):** Output "Review failed: headless mode requires a document path. Re-invoke with: Skill(\"js-compound-engineering:document-review\", \"mode:headless <path>\")" without dispatching agents.
...
- `js-compound-engineering:document-review:product-lens-reviewer`
- `js-compound-engineering:document-review:design-lens-reviewer`
- `js-compound-engineering:document-review:security-lens-reviewer`
- `js-compound-engineering:document-review:scope-guardian-reviewer`
- `js-compound-engineering:document-review:adversarial-document-reviewer`
