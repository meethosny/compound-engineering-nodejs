...
```
/js-ce-slack-research [topic or question]
/js-ce-slack-research
```
...
```
/js-ce-slack-research free trial
/js-ce-slack-research What did we say about free trial recently?
/js-ce-slack-research free trial in #proj-reverse-trial
/js-ce-slack-research onboarding flow after:2026-03-01
```
...
Dispatch `js-compound-engineering:research:slack-researcher` with the user's topic as the task prompt. Omit the `mode` parameter so the user's configured permission settings apply.
