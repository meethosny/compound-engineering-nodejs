#!/usr/bin/env python3
"""
list-plugin-releases.py — Fetch js-compound-engineering plugin releases from GitHub.
...
Environment:
  JS_CE_RELEASE_NOTES_GH_BIN  Override the gh binary path (default: "gh"). Used
...
OWNER = "meethosny"
REPO = "compound-engineering-nodejs"
TAG_PREFIX = "js-compound-engineering-v"
...
def attempt_gh(limit):
    ...
    """
    gh_bin = os.environ.get("JS_CE_RELEASE_NOTES_GH_BIN", "gh")
...
def attempt_anon(limit, api_base):
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "js-ce-release-notes-skill",
        },
    )
    try:
...
def main():
    parser = argparse.ArgumentParser(
        description="Fetch js-compound-engineering plugin releases from GitHub."
    )
    parser.add_argument(
        "--limit",
        type=int,
