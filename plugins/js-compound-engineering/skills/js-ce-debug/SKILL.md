...
How was this introduced? What allowed it to survive? If a systemic gap was found: "This pattern appears in N other files. Want to capture it with `/js-ce:compound`?"
...
2. Document as a learning (`/js-ce:compound`)
