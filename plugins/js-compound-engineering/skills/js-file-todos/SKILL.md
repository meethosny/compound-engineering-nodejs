...
issue_id: "002"
tags: [nodejs, performance, database]
...
| Trigger | Flow | Tool |
|---------|------|------|
| Code review | `/js-workflows:review` → Findings → `/triage` → Todos | Review agent + skill |
...
**Node.js Todo model (example):**
- Database model (if using ORM like Prisma or Sequelize)
