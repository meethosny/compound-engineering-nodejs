...
- **Upstream skill handoff** — `js-ce-brainstorm`, `js-ce-ideate`, or `js-ce-plan` finishes a draft and hands it off to publish for human review, passing the file path and title explicitly.
