...
- **"I want to actually learn this one"** — offer a handoff to the `js-ce-explain` skill for that item (offer, don't auto-fire); the brainstorm resumes when they return or continues with the default meanwhile.
