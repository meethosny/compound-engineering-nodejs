---
name: js-report-bug-ce
description: Report a bug in the js-compound-engineering plugin
argument-hint: "[optional: brief description of the bug]"
disable-model-invocation: true
---

# Report a JS Compound Engineering Plugin Bug

Report bugs encountered while using the js-compound-engineering plugin. This skill gathers structured information and creates a GitHub issue for the maintainer.
...
---
*Reported via `/js-report-bug-ce` skill*
```
...
```bash
gh issue create \
  --repo nicholasgriffintn/compound-engineering-nodejs \
...
Issue: https://github.com/nicholasgriffintn/compound-engineering-nodejs/issues/[NUMBER]
