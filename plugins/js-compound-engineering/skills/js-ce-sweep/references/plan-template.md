...
`js-ce-sweep` Phase 2g emits and re-reconciles a single rolling plan at `docs/plans/feedback-sweep-plan.md`. This file defines that plan's shape and the reconciliation rules. It is the contract the reconciler writes to, not the plan itself.
...
product_contract_source: js-ce-sweep
---
```
