...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        help="Directory for extracted evidence/kickoff artifacts. Defaults to docs/brainstorms/riffrec-feedback/<source-stem> when available; durable js-ce-brainstorm outputs live in docs/plans/.",
    )
...
def main() -> int:
    ...
    print(f"Brainstorm handoff: $compound-engineering:js-ce-brainstorm {display_path(kickoff_md, repo_root)}")
