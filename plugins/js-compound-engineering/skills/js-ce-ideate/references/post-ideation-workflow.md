...
- the workflow is about to hand off to `js-ce:brainstorm`, Proof sharing, or session end
...
- handing off to `js-ce:brainstorm`
- sharing to Proof
- ending the session
...
- invoke `js-ce:brainstorm` with the selected idea as the seed
