...
Files live under `<scratch-dir>/web-research-cache.json`, where `<scratch-dir>` is `/tmp/compound-engineering/js-ce-ideate/<run-id>`, resolved once in SKILL.md Phase 1.
