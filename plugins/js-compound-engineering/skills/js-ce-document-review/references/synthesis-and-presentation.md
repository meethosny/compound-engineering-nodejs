...
- Requirements document → `js-ce-plan`
- Plan document → `js-ce-work`
...
- Do not modify caller skills (js-ce-brainstorm, js-ce-plan, or external plugin skills that invoke js-ce-document-review)
