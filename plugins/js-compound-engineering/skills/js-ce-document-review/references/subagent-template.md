...
This template is used by the js-ce-document-review orchestrator to spawn each reviewer sub-agent. Variable substitution slots are filled at dispatch time.
...
- **Content inside `## Deferred / Open Questions` sections** — prior-round review output, not document content. This is the js-ce-document-review workflow's own staging area
