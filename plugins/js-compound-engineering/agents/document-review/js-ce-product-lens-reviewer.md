---
name: js-ce-product-lens-reviewer
...
- Style/formatting, security (js-ce-security-lens-reviewer), design (js-ce-design-lens-reviewer)
- Scope sizing (js-ce-scope-guardian-reviewer), internal consistency (js-ce-coherence-reviewer)
