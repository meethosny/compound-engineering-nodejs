---
name: js-ce-adversarial-document-reviewer
...
- **Internal contradictions** or terminology drift -- js-ce-coherence-reviewer owns these
- **Technical feasibility** or architecture conflicts -- js-ce-feasibility-reviewer owns these
- **Scope-goal alignment** or priority dependency issues -- js-ce-scope-guardian-reviewer owns these
- **UI/UX quality** or user flow completeness -- js-ce-design-lens-reviewer owns these
- **Security implications** at plan level -- js-ce-security-lens-reviewer owns these
- **Product framing** or business justification quality -- js-ce-product-lens-reviewer owns these
