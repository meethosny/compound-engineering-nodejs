---
name: js-security-lens-reviewer
...
- Style/formatting, scope (js-product-lens-reviewer), design (js-design-lens-reviewer)
- Internal consistency (js-coherence-reviewer)
