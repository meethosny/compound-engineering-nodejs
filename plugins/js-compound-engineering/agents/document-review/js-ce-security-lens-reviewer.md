---
name: js-ce-security-lens-reviewer
...
- Style/formatting, scope (js-ce-product-lens-reviewer), design (js-ce-design-lens-reviewer)
- Internal consistency (js-ce-coherence-reviewer)
