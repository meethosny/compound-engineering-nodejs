---
name: js-adversarial-document-reviewer
...
- **Internal contradictions** or terminology drift -- js-coherence-reviewer owns these
- **Technical feasibility** or architecture conflicts -- js-feasibility-reviewer owns these
- **Scope-goal alignment** or priority dependency issues -- js-scope-guardian-reviewer owns these
- **UI/UX quality** or user flow completeness -- js-design-lens-reviewer owns these
- **Security implications** at plan level -- js-security-lens-reviewer owns these
- **Product framing** or business justification quality -- js-product-lens-reviewer owns these
