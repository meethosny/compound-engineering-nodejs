...
- Style/formatting, security (js-security-lens-reviewer), design (js-design-lens-reviewer)
- Scope sizing (js-scope-guardian-reviewer), internal consistency (js-coherence-reviewer)
