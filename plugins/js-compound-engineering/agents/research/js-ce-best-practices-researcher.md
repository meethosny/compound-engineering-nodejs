---
name: js-ce-best-practices-researcher
...
2. **Identify Relevant Skills**:
   ...
   - Node.js/Server → `js-ce-modern-nodejs-style`, `js-ce-sindre-sorhus-package-writer`
   - Frontend/Design → `js-ce-frontend-design`
   - TypeScript/React → React best practices skills
   - AI/Agents → `js-ce-agent-native-architecture`, `js-create-agent-skills`
   - Documentation → `js-compound-docs`, `js-ce-every-style-editor`
   - File operations → `js-rclone`, `js-ce-git-worktree`
   - Image generation → `js-ce-gemini-imagegen`
...
2. **Organize Discoveries**:
   ...
   - Clearly indicate source: "From skill: js-ce-modern-nodejs-style" vs "From official docs" vs "Community consensus"
...
- **Skill-based**: "The js-ce-modern-nodejs-style skill recommends..." (highest authority - curated)
