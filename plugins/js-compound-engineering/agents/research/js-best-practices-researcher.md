...
2. **Identify Relevant Skills**:
   ...
   - Node.js/Server → `js-modern-nodejs-style`, `js-sindre-sorhus-package-writer`
   - Frontend/Design → `js-frontend-design`
   - TypeScript/React → React best practices skills
   - AI/Agents → `js-agent-native-architecture`, `js-create-agent-skills`
...
2. **Organize Discoveries**:
   ...
   - Clearly indicate source: "From skill: js-modern-nodejs-style" vs "From official docs" vs "Community consensus"
...
- **Skill-based**: "The js-modern-nodejs-style skill recommends..." (highest authority - curated)
