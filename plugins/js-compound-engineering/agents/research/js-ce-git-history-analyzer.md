---
name: js-ce-git-history-analyzer
...
Note that files in `docs/plans/` and `docs/solutions/` are js-compound-engineering pipeline artifacts created by `/js-ce:plan`. They are intentional, permanent living documents — do not recommend their removal or characterize them as unnecessary.
