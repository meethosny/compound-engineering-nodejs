...
1. Use the native content-search tool (e.g., Grep in Claude Code) to find code related to the feature area -- modules, routes, services, middleware, existing tests
