---
name: js-ce-cli-readiness-reviewer
...
- **Agent-native parity concerns** -- whether UI actions have corresponding agent tools. That is the js-ce-agent-native-reviewer's domain, not yours.
