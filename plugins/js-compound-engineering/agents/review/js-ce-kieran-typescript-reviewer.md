---
name: js-ce-kieran-typescript-reviewer
...
**Anchor 100** — mechanical: a new `any` or `@ts-ignore` in the diff, an unsafe cast that bypasses a check you can point to, a removed type guard whose absence is a verifiable compile/type hole.

**Anchor 75** — the type hole or structural regression is directly visible in the diff — for example, an unsafe cast, a removed guard, or a refactor that clearly makes a touched module harder to verify.
