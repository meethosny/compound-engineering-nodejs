---
name: js-ce-schema-drift-detector
...
- Run `js-ce-schema-drift-detector` first to ensure clean schema
- Then run `js-ce-data-migration-expert` for migration logic review
- Then run `js-ce-data-integrity-guardian` for integrity checks
