...
<requirements>
- Local development server running (e.g., `npm run dev`, `npm start`)
...
| `src/pages/users/[id].tsx` | `/users/:id` (use sample ID) |
| `src/components/*` | Find pages importing these |
...
| File Pattern | Route(s) |
|-------------|----------|
| `routes/*.ts` | Parse routes from file |
| `src/routes/*.ts` | Parse routes from file |
| `views/*.ejs` | Routes rendering these templates |
...
| File Pattern | Route(s) |
|-------------|----------|
| `src/components/*` | Pages importing those components |
| `src/styles/*` | Visual pages |
...
```
Video: https://your-r2-public-url/pr-videos/pr-[number]/feature-demo.mp4
Preview: https://your-r2-public-url/pr-videos/pr-[number]/feature-demo-preview.gif
```
...
Example:
```markdown
[![Feature Demo](https://your-r2-url/pr-videos/pr-137/feature-demo-preview.gif)](https://your-r2-url/pr-videos/pr-137/feature-demo.mp4)
```
