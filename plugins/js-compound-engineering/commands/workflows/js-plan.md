...
- Task js-spec-flow-analyzer(feature_description, research_findings)
...
5. **After creation:**
   ...
   - Ask if they want to proceed to `/js-workflows:work` or `/js-plan_review`
