...
- [ ] If DIFFERENT branch → offer to use worktree: "Use git-worktree skill for isolated Call `skill: js-git-worktree` with branch name
...
Run the Task js-code-simplicity-reviewer() to see if we can simplify the code.
...
| `package.json`, `src/*`, `*.js`, `*.ts` | Web (Node.js) |
...
**For Hybrid Projects (e.g., Node.js + React Native):**
```markdown
