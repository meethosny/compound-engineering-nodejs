...
2. **Consider Reviewer Agents** (Optional)
   ...
   - **kieran-nodejs-reviewer**: Verify Node.js conventions (Node.js projects)
   - **kieran-typescript-reviewer**: Verify TypeScript conventions
   - **modern-nodejs-reviewer**: Check modern Node.js best practices
   ...
   Task(kieran-nodejs-reviewer): "Check Node.js conventions"
   ```
