...
const PLUGIN_ROOT = path.join(process.cwd(), "plugins", "js-compound-engineering", "skills")
...
const SKILLS_WITH_COPIES = ["js-ce-compound", "js-ce-compound-refresh"]

describe("js-ce:compound support file drift", () => {
