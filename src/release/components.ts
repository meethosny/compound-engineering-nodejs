...
const FILE_COMPONENT_MAP: Array<{ component: ReleaseComponent; prefixes: string[] }> = [
  ...
  {
    component: "js-compound-engineering",
    prefixes: ["plugins/js-compound-engineering/"],
  },
  {
    component: "js-coding-tutor",
    prefixes: ["plugins/js-coding-tutor/"],
  },
  {
...
const SCOPES_TO_COMPONENTS: Record<string, ReleaseComponent> = {
  cli: "cli",
  compound: "js-compound-engineering",
  "js-compound-engineering": "js-compound-engineering",
  "js-coding-tutor": "js-coding-tutor",
...
export async function loadCurrentVersions(cwd = process.cwd()): Promise<VersionSources> {
  ...
  const ce = await readJson<PluginManifest>(`${cwd}/plugins/js-compound-engineering/.claude-plugin/plugin.json`)
  const codingTutor = await readJson<PluginManifest>(`${cwd}/plugins/js-coding-tutor/.claude-plugin/plugin.json`)
  ...
  return {
    cli: root.version,
    "js-compound-engineering": ce.version,
    "js-coding-tutor": codingTutor.version,
